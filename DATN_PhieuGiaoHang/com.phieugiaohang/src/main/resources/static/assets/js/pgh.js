app.controller("delivery-note-ctrl",function($scope,$http){
    $scope.deliveryNoteLists =[];
    $scope.orders =[];
    $scope.cates = [];
    $scope.form = {};
    ...
    $scope.initialize = function(){
        //load products
        $http.get("/rest/delivery-note/get-all").then(resp=>{
            $scope.deliveryNoteLists = resp.data;
            $scope.deliveryNoteLists.forEach(deliveryNoteList=>{
                deliveryNoteList.dateInsert = new Date(deliveryNoteList.dateInsert)
            })
        });
        //load categorys
    ...
    $scope.create = function(){
        ...
        $http.post(`/rest/delivery-note/create`,item).then(resp=>{
